...
namespace Aptiv.DBCFiles
{
    ...
    public class DBCFile : IDBCFile
    {
        ...
        public Dictionary<string, int> NS_Lib = new Dictionary<string, int>();
        public Dictionary<string, int> BS_Lib = new Dictionary<string, int>();
        public Dictionary<int, string> MsgSendTypes = new Dictionary<int, string>();
        public Dictionary<string, DBCECU> ecus = new Dictionary<string, DBCECU>();
        public Dictionary<string, DBCMessage> messages = new Dictionary<string, DBCMessage>();
